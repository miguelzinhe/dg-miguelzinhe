module.exports = {
  ...
  siteMetadata: {
    title: `miguelzinhe`,
    subtitle: `jardim de conhecimentos de miguelzinhe`,
    description: `um pedacinho do meu cérebro na internet a.ka digital garden. tudo publicado aqui são reflexões à partir de estudos pessoais que podem ser modificados a qualquer momento. eu não sou detentor do conhecimento do mundo, tô aprendendo que nem você.`,

    siteUrl: `https://miguelzinhe.com/notes/`, // URL at which your site will be published. This should be present if you want RSS feed.
    headerMenu: [ // Top Navbar items
      {type: 'page', item: '', title: 'início'}, // Type can be 'page', 'note', 'tag', or 'link'
      {type: 'page', item: 'sobre', title: 'sobre mim'},
      {type: 'page', item: 'sitemap', title: 'mapa do site'},
      {
        type: 'page', item: 'tags', title: 'assuntos',
        menu: [ // Only one level depth, please.
          {type: 'tag',item: 'genero'},
        ]
      },
    ],
  ...
  plugins: [
                ...
                allMdx(
                  ...
                  edges {
                    node {
                      excerpt
                      html
                      fields { slug date title description}
                    }
                  }
                }
              }
...

    {
      ...
      options: {
        ...
        // Default: all fields
        store: ['id', 'slug', 'title', 'excerpt', 'description'],
